...
const STRINGS = {
  pt: {
    ...
    ltNotSavedYet: "Esta etapa só recolhe as correções — ainda não salva nada nem muda o pacote.",
  },
  en: {
    ...
    ltNotSavedYet: "This step only collects the corrections — nothing is saved and the package is not changed yet.",
  },
} as const;
